...
Material kept for provenance rather than for building or running CSGN. Nothing
in here is referenced by the app, the functions or the docs, and nothing here
should be treated as current — the live product is described by the root
[`README.md`](../README.md) and the guides in [`docs/`](../docs).
